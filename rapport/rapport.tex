...
L'\textbf{approche par taux de risque normalisés} (par habitant ou par kilomètre d'aménagement) offre une méthodologie plus rigoureuse. Les performances plus modestes (R² de 20-30\%) reflètent la complexité réelle du problème et l'insuffisance des données disponibles.
